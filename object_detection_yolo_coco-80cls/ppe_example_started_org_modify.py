...
def create_args():
    ...
    args.model_name = "BSNet0-20240820_0-YOLOv9"

    args.model_path = '/home/dpi/raspberrypi_20241209/inference/example/utils/object_detection_yolov9/req_files_ppr/sep_23_model_416x416x3_inv-f.tachyrt'
    #args.model_path = args.model
    args.clss_dict  = read_json('/home/dpi/raspberrypi_20241209/inference/example/utils/object_detection_yolov9/req_files_ppr/class.json')
...
def inference(args):
    ...
    for i, img in enumerate(args.images_input):
        ...
        args.post_config = read_json('/home/dpi/raspberrypi_20241209/inference/example/utils/object_detection_yolov9/req_files_ppr/post_process_416x416x3.json')
        
        sys.path.append('/home/dpi/raspberrypi_20241209/inference/example/utils/object_detection_yolov9/req_files_ppr')
...
def display(args):
    ...
    #cv2.waitKey(0)
    cv2.imwrite('/home/dpi/raspberrypi_20241209/inference/example/object_detection_yolo_coco-80cls/result.png', total_img)
